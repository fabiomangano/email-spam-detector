  ...
  async testResult(@Res() res: Response) {
    try {
      ...
      const mockResult = await this.resultService.generateResult(
        { bodyLength: 1000, numLinks: 2, linkRatio: 0.002, numImages: 1, hasTrackingPixel: false, hasAttachments: false, numAttachments: 0, attachmentTypes: [], spfResult: 'pass', dkimResult: 'pass', dmarcResult: 'pass', ipSender: '192.168.1.1', isHtmlOnly: false, numDomains: 2, replyToDiffersFromFrom: false },
